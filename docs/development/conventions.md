...
- `src/core/` owns the orchestration domain: config resolution, the iteration loop, the creator/critic/fixer/reviewer/translate passes, the clarification gate, plan validation, resume, summaries, and the run context. Pure decision logic lives here.
